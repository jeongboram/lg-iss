...
export const sub_service_tabledata = {
	...
	description: {
		...
		cellStyle: [ROWHEADER_TYPE.FIRST, ROWHEADER_TYPE.LONG],
		cellWidth: ['30%', '70%'],
		rowdata: [
			{ row: ['Channel Organization', 'App service not available App service not available App service not available'] },
			{ row: ['APP Organization', 'Schedule error Schedule errorSchedule errorSchedule '] },
			{ row: ['Data Deployment', 'App service not available App service not available App service not available'] },
			{ row: ['APP Organization', 'Schedule error Schedule errorSchedule errorSchedule '] },
			{ row: ['Channel Organization', 'App service not available App service not available App service not available'] },
			{ row: ['APP Organization', 'Schedule error Schedule errorSchedule errorSchedule '] },
			{ row: ['Channel Organization', 'App service not available App service not available App service not available'] },
